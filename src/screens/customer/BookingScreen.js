      ...
      <SafeAreaView style={[styles.container, { justifyContent: 'center', alignItems: 'center', padding: 24 }]}>
        ...
        <View style={styles.summaryCard}>
          ...
          <View style={styles.summaryRow}>
            ...
            <Text style={styles.summaryVal}>Ramesh Kumar</Text>
          </View>
          <View style={styles.summaryRow}>
            <Text style={styles.summaryLabel}>Estimated Cost</Text>
            <Text style={[styles.summaryVal, { color: colors.primary }]}>₹400 / hr</Text>
          </View>
        </View>
    ...
    <SafeAreaView style={styles.container}>
      ...
      <ScrollView contentContainerStyle={styles.formContainer}>
        <View style={styles.workerBrief}>
          ...
          <View>
            <Text style={styles.workerName}>Ramesh Kumar</Text>
            <Text style={styles.workerSkill}>Expert Plumber • ₹400/hr</Text>
          </View>
        </View>
