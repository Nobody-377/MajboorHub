    ...
    <ScrollView style={styles.container} bounces={false}>
      ...
      <View style={styles.section}>
        <View style={styles.sectionHeader}>
          <Text style={styles.sectionTitle}>New Requests (3)</Text>
          <Text style={styles.seeAll} onPress={() => navigation.navigate('Jobs')}>View All</Text>
        </View>
        <TouchableOpacity style={styles.requestItem} onPress={() => navigation.navigate('Jobs')}>
          <View style={styles.requestIconBg}>
            <Bell size={20} color={colors.surface} />
          </View>
          <View style={styles.requestInfo}>
            <Text style={styles.requestTitle}>Water tank installation</Text>
            <Text style={styles.requestMeta}>2.5 km away • Today, 2:00 PM</Text>
          </View>
          <Text style={styles.requestPrice}>₹600</Text>
        </TouchableOpacity>
      </View>
    </ScrollView>
  );
...
const styles = StyleSheet.create({
  ...
  headerBg: { backgroundColor: colors.primary, paddingHorizontal: 20, paddingBottom: 50, borderBottomLeftRadius: 24, borderBottomRightRadius: 24 },
